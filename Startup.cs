...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new Info { Title = "Rate Uplift service", Version = "v1" });
        ...
        if (creds.username != null && creds.password != null && creds.host != null)
        {
            ...
            services.AddTransient<IPostRateupliftProcessor, PostRateupliftProcessor>();
            services.AddTransient<IPutRateupliftProcessor, PutRateupliftProcessor>();
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "Rate Uplift Web API V1");
